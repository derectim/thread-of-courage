...
export const ACTIVE_ABILITIES: readonly ActiveAbilityDefinition[] = [
  {
    ...
    name: "Петля времени",
    shortName: "Петля",
    description: "На несколько секунд сильно замедляет узор противника.",
    symbol: "◷",
    unlockStage: 1,
    chargesPerStage: 2,
    cooldownMs: 7_000,
  ...
  },
  {
    ...
    shortName: "Магнит",
    description: "Следующая игла мягко найдёт свободное место рядом с целью.",
    symbol: "⌁",
    unlockStage: 6,
    chargesPerStage: 2,
    cooldownMs: 5_000,
  },
  {
    ...
    name: "Запасной узел",
    shortName: "Узел",
    description: "Возвращает один щит или один раз спасает от столкновения.",
    symbol: "◇",
    unlockStage: 12,
    chargesPerStage: 1,
    cooldownMs: 0,
