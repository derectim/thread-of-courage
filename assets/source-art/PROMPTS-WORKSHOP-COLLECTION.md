...
## Запечатанная неизвестная награда — 2026-09-04

`ui-reward-mystery-parcel.png` создан встроенной генерацией изображений Codex
в режиме `stylized-concept`. Игровая версия
`../../public/assets/art/ui-reward-mystery-parcel.webp` уменьшена до 320×320 и
сохраняет прозрачный фон.

Ключевой промпт: один закрытый свёрток из угольно-индигового бархата,
перевязанный золотой нитью, с латунной пуговицей-печатью и бирюзовыми стежками;
оригинальный рисованный UI-ассет уютной волшебной швейной мастерской, читаемый
при 48–160 px, с щедрыми прозрачными полями. Запрещены показ содержимого,
текст, буквы, цифры, вопросительный знак, рамка карточки, интерфейс, персонажи,
оружие, сцена, водяной знак, пиксель-арт и неоновое свечение.
